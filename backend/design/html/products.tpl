                ...
                <form method="post" class="fn_form_list fn_fast_button">
                    ...
                    <div class="okay_list products_list fn_sort_list">
                        ...
                        <div class="fn_step_sorting okay_list_head">
                            ...
                            <div class="okay_list_heading okay_list_id">
                                {if $smarty.get.sort == 'id'}
                                    {$sort = 'id_desc'}
                                {else}
                                    {$sort = 'id'}
                                {/if}
                                <a href="{url sort=$sort page=null}" class="{$sort}{if $smarty.get.sort == 'id' || $smarty.get.sort == 'id_desc'} active{/if}">
                                    {$btr->general_id|escape} {include file='svg_icon.tpl' svgId='sorting'}
                                </a>
                            </div>
                            ...
                            {foreach $products as $product}
                                <div class="fn_step-1 fn_row okay_list_body_item fn_sort_item">
                                    <div class="okay_list_row">
                                        ...
                                        <div class="okay_list_boding okay_list_id">
                                        ...
                                        {foreach $product->variants as $variant}
                                            {if $variant@iteration > 1}
                                                <div class="okay_list_row">
                                                    ...
                                                    <div class="okay_list_boding okay_list_price">
                                                        <div class="input-group">
                                                            <span class="form-control">{$variant->price|escape}</span>
                                                            <span class="input-group-addon">
                                                    ...
                                                    <div class="okay_list_boding okay_list_count">
                                                        <div class="input-group">
                                                            <span class="form-control">{if $variant->infinity}∞{else}{$variant->stock|escape}{/if}</span>
                                                            <span class="input-group-addon p-0">
