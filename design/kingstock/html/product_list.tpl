...
<div class="product_preview fn_product">
	<div class="fn_transfer clearfix">
		<div class="d-flex product_preview__image _ibg  _ibg--contain">
					...
					<div class="stickers">
						...
						{if $product->special}
							<span class="sticker sticker--special">
								<img class="sticker__image" src='files/special/{$product->special}' alt='{$product->special|escape}'
			...
			<div class="product_preview__actions actions_preview product_preview__bottom">
				<form class="fn_variants preview_form" action="{url_generator route="cart"}">

					<ul class="actions_preview__list">
						{if !$settings->is_preorder}
							{* Out of stock *}
							<li class="actions_preview__item {if $product->variant->stock > 0} hidden-xs-up{/if}">
						...
						{/if}
						<li class="actions_preview__item {if $product->variant->stock < 1} hidden-xs-up{/if}">
							{* Submit cart button *}
						...
						<li class="actions_preview__item">
					...
					<div class="product_preview__variants swiper-no-swiping {if $product->variants|count == 1}hidden{/if}">
						<select name="variant"
