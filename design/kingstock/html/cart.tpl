						...
						<form id="captcha_id" method="post" name="cart" class="fn_validate_cart">
							<div class="f_row flex-column align-items-start flex-lg-row">
								<div class="position_sticky f_col f_col-lg-6 f_col-xl-5">
									...
									<div class="block--cart_purchases">
											...
											<div class="purchase_detail">
												...
												<div class="purchase_detail__item">
													<div class="purchase_detail__column_name">
														<div class="purchase_detail__name" data-language="cart_order_price">
															{$lang->cart_order_price}:</div>
													</div>
													<div class="purchase_detail__column_value">
														<div id="fn_total_purchases_price" class="purchase_detail__price">
															{$cart->total_price|convert} {$currency->sign|escape}</div>
													</div>
												</div>
												...
												<div id="fn_total_delivery_price_block" class="purchase_detail__item">
													<div class="purchase_detail__column_name">
														<div class="purchase_detail__name" data-language="cart_discount">
															<span
																data-language="cart_delivery_order_price">{$lang->cart_delivery_order_price}</span>
															<span id="fn_total_separate_delivery"
																{if !$active_delivery->separate_payment || $active_delivery->is_free_delivery === true}
																style="display: none;" {/if}> ({$lang->cart_paid_separate})</span>:
														</div>
													</div>
													<div class="purchase_detail__column_value">
														<div id="fn_total_delivery_price" class="purchase_detail__price"
															{if $active_delivery->is_free_delivery === true} style="display: none;" {/if}>
															{$active_delivery->price|convert} {$currency->sign|escape}
														</div>
														<div id="fn_total_free_delivery" class="purchase_detail__price"
															data-language="cart_free" {if $active_delivery->is_free_delivery === false}
												...
												<div class="purchase_detail__item">
													<div class="purchase_detail__column_name">
														<div class="purchase_detail__name purchase_detail__name--total"
															data-language="cart_total_price">{$lang->cart_total_price}:</div>
													</div>
													<div class="purchase_detail__column_value">
														<div class="purchase_detail__price purchase_detail__price--total">
															{*Итоговую стоимость выводим с активной доставки*}
															<span><span
																	id="fn_cart_total_price">{$active_delivery->total_price_with_delivery|convert}</span>
													...
													{if $error}
														<div class="message_error">
															...
															{elseif $error == 'empty_phone'}
																<span data-language="form_error_phone">{$lang->form_error_phone}
																	{$lang->form_error_phone_example} {$phone_example}</span>
															{else}
													...
													<div class="f_row">
														...
														<div class="f_col-md-6 f_col-lg-12 f_col-xl-6">
															<div class="form__group ">
																...
																<input class="form__input" name="last_name" type="text"
																	value="{$request_data.last_name|escape}" data-language="form_name"
																	placeholder="{$lang->form_enter_last_name}">
															</div>
														</div>
														...
														<div class="f_col-md-6 f_col-lg-12 f_col-xl-6">
															...
															<label class="form__group_label"> {$lang->form_phone}</label>
																<input class="form__input" name="phone" type="text"
																	value="{$request_data.phone|escape}" data-language="form_phone" placeholder="{$lang->form_enter_phone}">
															</div>
														</div>
														...
														<div class="f_col-md-6 f_col-lg-12 f_col-xl-6">
															...
															<label class="form__group_label"> {$lang->form_address}</label>
																<input class="form__input" name="address" type="text"
																	value="{$request_data.address|escape}" data-language="form_address" placeholder="{$lang->form_enter_address}">
															</div>
														</div>
														...
														<div class="f_col-xl-12">
															...
															<label class="form__group_label"> {$lang->cart_order_comment}</label>
																<textarea class="form__textarea" rows="3" name="comment"
																	data-language="cart_order_comment" placeholder="{$lang->form_enter_message}">{$request_data.comment|escape}</textarea>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="form__footer">
													...
													{if $settings->captcha_cart}
														...
														{elseif $settings->captcha_type == "default"}
															...
															<div class="captcha">
																<div class="secret_number">{$captcha_cart[0]|escape} + ? =
																	{$captcha_cart[1]|escape}</div>
																<div class="form__captcha">
																	<input class="form__input form__input_captcha" type="text" name="captcha_code"
																		value="" />
																</div>
															</div>
														{/if}
													...
													{* Submit button *}
													<button class="form__button button--blick g-recaptcha" type="submit" name="checkout"
