...
<div class="clearfix">
	...
	<div class="products_container d-flex flex-column">
		<div class="products_container__boxed">
			<div class="products_container__top">
				<h1 class="h1" {if $category} data-category="{$category->id}" {/if}{if $brand} data-brand="{$brand->id}"
					{/if}>
					{$h1|escape}
				</h1>
				{if $products}
					<div class="products_container__sort d-flex align-items-center justify-content-end">
						{* Product Sorting *}
						<div
							class="fn_products_sort products_container__sort_wrap d-flex align-items-center justify-content-end">
