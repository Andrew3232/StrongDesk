    ...
    {* Include fonts *}
	 <link href="{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-SemiBold.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">
    <link href="{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-Bold.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">

    <style>
        @font-face {
            font-family: 'Montserrat';
            font-display: swap;
            src: local('Montserrat Bold'), local('CenturyGothic-Bold'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-Bold.woff2') format('woff2'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-Bold.woff') format('woff');
            font-weight: bold;
            font-style: normal;
        }
        @font-face {
            font-family: 'Montserrat';
            font-display: swap;
            src: local('Montserrat Regular'), local('CenturyGothic-Regular'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-Regular.woff2') format('woff2'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/century-gothic/CenturyGothic-Regular.woff') format('woff');
            font-weight: normal;
            font-style: normal;
        }
    </style>
