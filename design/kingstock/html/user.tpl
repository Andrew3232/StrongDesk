        ...
        <div class="user_container position_sticky d-flex flex-column">
            <div class="tabs__content user_container__boxed">
                <div id="user_info" class="tab"{if empty($active_tab)} style="display: block;"{/if}>
                    ...
                    <div class="block mobile_tab__content">
                                                ...
                                                <div class="f_row">
                                                    <div class="f_col-md-12 f_col-lg-6 f_col-xl-12">
                                                        ...
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" value="{$user->name|escape}" name="name" type="text" data-language="form_name" />
                                                        </div>
                                                    </div>
                                                    <div class="f_col-md-12 f_col-lg-6 f_col-xl-12">
                                                        {* User's last name *}
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" value="{$user->last_name|escape}" name="last_name" type="text" data-language="form_name" />
                                                        </div>
                                                    </div>
                                                    <div class="f_col-md-12 f_col-lg-6 f_col-xl-12">
                                                        {* User's email *}
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" value="{$user->email|escape}" name="email" type="text" data-language="form_email" />
                                                        </div>
                                                    </div>
                                                    <div class="f_col-md-12 f_col-lg-6 f_col-xl-12">
                                                        {* User's phone *}
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" value="{$user->phone|phone}" name="phone" type="text" data-language="form_phone" />
                                                        </div>
                                                    </div>
                                                    <div class="f_col-md-12 f_col-lg-6 f_col-xl-12">
                                                        {* User's address *}
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" value="{$user->address|escape}" name="address" type="text" data-language="form_address" />
                                                        </div>
                                                    </div>
                                                    <div class="f_col-md-12">
                                                        ...
                                                        <div class="form__group">
                                                            ...
                                                            <input class="form__input" id="fn_password" value="" name="" type="" style="display:none;"{* placeholder="{$lang->user_change_password}*}"/>
                                                        </div>
                                                    </div>
