<div class="fp_purchase_data">
    ...
    <input type="hidden" name="fp_product_id" value="{$purchase->id}" disabled>
    <input type="hidden" name="fp_product_name" value="{$purchase->name}" disabled>
    <input type="hidden" name="fp_variant_name" value="{$purchase->variant->name}" disabled>
    <input type="hidden" name="fp_quantity" value="{$purchase->amount}" disabled>
    <input type="hidden" name="fp_price" value="{$purchase->price}" disabled>
